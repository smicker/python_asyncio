"""
This demo shows that the await will give the control back to asyncio when awating
a task. But it will not give the control back to asyncio when awating a coroutine.
